...
- `part_a.py` compares UCB and EXP3 across a range of horizon values.
...
- compares UCB and EXP3, where EXP3 uses the theoretical learning rate η = √(2 ln K / (T K)) for each horizon
